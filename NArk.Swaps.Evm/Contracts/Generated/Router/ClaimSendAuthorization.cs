...
{
    public partial class ClaimSendAuthorization : ClaimSendAuthorizationBase { }

    public class ClaimSendAuthorizationBase 
    {
        [Parameter("uint256", "minAmountLd", 1)]
        public virtual BigInteger MinAmountLd { get; set; }
        [Parameter("uint256", "lzTokenFee", 2)]
