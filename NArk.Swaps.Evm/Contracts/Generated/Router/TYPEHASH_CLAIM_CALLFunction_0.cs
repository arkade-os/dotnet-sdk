...
{
    public partial class TypehashClaimCallFunction : TypehashClaimCallFunctionBase { }

    [Function("TYPEHASH_CLAIM_CALL", "bytes32")]
    public class TypehashClaimCallFunctionBase : FunctionMessage
    {
